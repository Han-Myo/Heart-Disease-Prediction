...
# -----------------------------------------------------------
model = joblib.load(r"C:\Users\Ibifu\Documents\GitHub\best_models\final_logistic_regression.pkl")
scaler = joblib.load(r"C:\Users\Ibifu\Documents\GitHub\best_models\scaler.pkl")
